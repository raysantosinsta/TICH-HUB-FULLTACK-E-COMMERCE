    ...
    <div class="container nav-container-premium">
      ...
      <div class="nav-links-premium">
        ...
        >
          <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
            <path
              d="M20 7L12 12L4 7M20 7V17L12 22M20 7L12 2L4 7M12 22V12"
              stroke="currentColor"
              stroke-width="1.5"
              fill="none"
            />
      ...
      <div class="nav-icons-premium">
        ...
        >
          ...
          <span
            ...
            class="badge-premium favorites-badge"
            >{{ totalFavorites }}</span
          >
        </router-link>
        ...
        >
          ...
          <span v-if="cartTotalItems > 0" class="badge-premium cart-badge">{{
            cartTotalItems
          }}</span>
        </router-link>
        ...
        <div class="user-menu-premium" v-click-outside="closeUserMenu">
          <button
            class="icon-btn-premium user-btn"
          ...
          <transition name="dropdown-premium">
            <div v-if="showUserMenu" class="user-dropdown-premium">
              ...
              <div v-else class="user-info-premium guest">
                <div class="user-avatar-premium guest-avatar">👤</div>
                <div class="user-details-premium">
                  <p class="user-name-premium">Visitante</p>
                  <p class="user-email-premium">
              ...
              >
                ...
                Favoritos
                <span v-if="totalFavorites > 0" class="item-badge-premium">{{
                  totalFavorites
                }}</span>
              </router-link>
              ...
              >
                ...
                Carrinho
                <span v-if="cartTotalItems > 0" class="item-badge-premium">{{
                  cartTotalItems
                }}</span>
              </router-link>
              ...
              <button
                v-if="isAuthenticated"
                class="dropdown-item-premium logout-btn-premium"
                @click="handleLogout"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path
              ...
              <router-link
                v-else
                to="/login"
                class="dropdown-item-premium login-link-dropdown-premium"
                @click="closeUserMenu"
              >
                <svg width="18" height="18" viewBox="0 0 24 24" fill="none">
                  <path
